...
class DataHeap extends DataBT implements IHeap {
	...
	public LinkedList<Integer> makeList() {
		...
		if (this.right instanceof DataHeap) {
			elements.addAll(((DataHeap) this.right).makeList());
		}
	...
	@Override
	public DataHeap rightHeap() {
		if (right.size() > 0) return new DataHeap();
	}

	@Override
	public DataHeap leftHeap() {
